...
const ProfilePage = () => {
	...
	return (
		<>
			<Head>
				<title>Focus Otter Presentations</title>
			</Head>
			<Flex direction="column" width="100%" alignItems="center" height="90vh">
				...
				>
					<Flex direction="column" gap="1em">
						<Heading level={4}>
							Hey there! <MdWavingHand color={'#FFA500'} />
						</Heading>
						<Text>
							Want to give or look at some presentations? Well you're in the
							right place!
						</Text>
